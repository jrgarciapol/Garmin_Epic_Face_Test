...
HP = f"{SRC}/SueEllenFrancisco-Regular.ttf"
f_time = ImageFont.truetype(HP, 208)   # hora interactiva
f_aod = ImageFont.truetype(HP, 208)    # hora AOD
f_num = ImageFont.truetype(HP, 110)     # nº día
