...
JOBS = [
    ("TimeBig", "SueEllenFrancisco-Regular.ttf", 208, TIME_CHARS, True),
    ("AodBig",  "SueEllenFrancisco-Regular.ttf", 208, TIME_CHARS, True),
    ("NumBig",  "SueEllenFrancisco-Regular.ttf", 110, DIGITS,     True),
    ("MonBig",  "SueEllenFrancisco-Regular.ttf", 92, LETTERS,    False),
]
