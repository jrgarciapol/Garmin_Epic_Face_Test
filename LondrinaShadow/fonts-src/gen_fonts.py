...
JOBS = [
    ("TimeBig", "LondrinaShadow-Regular.ttf", 192, TIME_CHARS, True),
    ("AodBig",  "LondrinaShadow-Regular.ttf", 192, TIME_CHARS, True),
    ("NumBig",  "LondrinaShadow-Regular.ttf", 106, DIGITS,     True),
    ("MonBig",  "LondrinaShadow-Regular.ttf", 92, LETTERS,    False),
]
