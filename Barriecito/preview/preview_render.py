...
HP = f"{SRC}/Barriecito-Regular.ttf"
f_time = ImageFont.truetype(HP, 196)   # hora interactiva
f_aod = ImageFont.truetype(HP, 196)    # hora AOD
f_num = ImageFont.truetype(HP, 108)     # nº día
