...
JOBS = [
    ("TimeBig", "Barriecito-Regular.ttf", 196, TIME_CHARS, True),
    ("AodBig",  "Barriecito-Regular.ttf", 196, TIME_CHARS, True),
    ("NumBig",  "Barriecito-Regular.ttf", 108, DIGITS,     True),
    ("MonBig",  "Barriecito-Regular.ttf", 92, LETTERS,    False),
]
