...
JOBS = [
    ("TimeBig", "Smokum-Regular.ttf", 208, TIME_CHARS, True),
    ("AodBig",  "Smokum-Regular.ttf", 208, TIME_CHARS, True),
    ("NumBig",  "Smokum-Regular.ttf", 110, DIGITS,     True),
    ("MonBig",  "Smokum-Regular.ttf", 92, LETTERS,    False),
]
