...
HP = f"{SRC}/CaesarDressing-Regular.ttf"
f_time = ImageFont.truetype(HP, 172)   # hora interactiva
f_aod = ImageFont.truetype(HP, 172)    # hora AOD
f_num = ImageFont.truetype(HP, 95)     # nº día
f_mon = ImageFont.truetype(HP, 86)     # mes y día semana
