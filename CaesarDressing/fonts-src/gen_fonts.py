...
JOBS = [
    ("TimeBig", "CaesarDressing-Regular.ttf", 172, TIME_CHARS, True),
    ("AodBig",  "CaesarDressing-Regular.ttf", 172, TIME_CHARS, True),
    ("NumBig",  "CaesarDressing-Regular.ttf", 95, DIGITS,     True),
    ("MonBig",  "CaesarDressing-Regular.ttf", 86, LETTERS,    False),
]
