...
HP = f"{SRC}/Honk-Regular.ttf"
f_time = ImageFont.truetype(HP, 174)   # hora interactiva
f_aod = ImageFont.truetype(HP, 174)    # hora AOD
f_num = ImageFont.truetype(HP, 96)     # nº día
f_mon = ImageFont.truetype(HP, 87)     # mes y día semana
