...
HP = f"{SRC}/RampartOne-Regular.ttf"
f_time = ImageFont.truetype(HP, 152)   # hora interactiva
f_aod = ImageFont.truetype(HP, 152)    # hora AOD
f_num = ImageFont.truetype(HP, 84)     # nº día
f_mon = ImageFont.truetype(HP, 76)     # mes y día semana
