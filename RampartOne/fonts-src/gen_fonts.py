...
JOBS = [
    ("TimeBig", "RampartOne-Regular.ttf", 152, TIME_CHARS, True),
    ("AodBig",  "RampartOne-Regular.ttf", 152, TIME_CHARS, True),
    ("NumBig",  "RampartOne-Regular.ttf", 84, DIGITS,     True),
    ("MonBig",  "RampartOne-Regular.ttf", 76, LETTERS,    False),
]
