...
HP = f"{SRC}/Bangers-Regular.ttf"
f_time = ImageFont.truetype(HP, 170)   # hora interactiva
f_aod = ImageFont.truetype(HP, 170)    # hora AOD
f_num = ImageFont.truetype(HP, 94)     # nº día
f_mon = ImageFont.truetype(HP, 85)     # mes y día semana
