...
JOBS = [
    ("TimeBig", "Bangers-Regular.ttf", 170, TIME_CHARS, True),
    ("AodBig",  "Bangers-Regular.ttf", 170, TIME_CHARS, True),
    ("NumBig",  "Bangers-Regular.ttf", 94, DIGITS,     True),
    ("MonBig",  "Bangers-Regular.ttf", 85, LETTERS,    False),
]
